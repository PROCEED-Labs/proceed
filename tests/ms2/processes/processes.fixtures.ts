...
import { PropertiesPanelPage } from './process-modeler/properties-panel/properties-panel.page';
import { MS2Page } from '../ms2.page';
import { ProcessListPage } from './process-list.page';
import { ProcessModelerPage } from './process-modeler/process-modeler.page';
