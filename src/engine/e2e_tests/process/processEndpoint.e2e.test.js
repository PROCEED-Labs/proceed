...
describe('Test process endpoints', () => {
  describe('GET/POST /process', () => {
    ...
    it('registers an image as a dependency if it is referenced in the bpmn', async () => {
