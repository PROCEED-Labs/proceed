...
import styles from '../../../(dashboard)/[environmentId]/processes/[processId]/modeler.module.scss';
...
const Modeler = ({ process, isViewer = false, ...divProps }: ModelerProps) => {
  ...
  const canEdit = !selectedVersionId && !showMobileView && !isViewer;
  ...
  return (
    <div className={styles.Modeler} style={{ height: '100%' }}>
      <>
        {loaded && <ModelerToolbar viewOnly={isViewer} canRedo={canRedo} canUndo={canUndo} />}
