...
import { Upload, Image, notification, Spin } from 'antd';
...
const ImageSelectionSection: React.FC<ImageSelectionSectionProperties> = ({
  ...
  const { upload, download, remove, isLoading, reset, downloadUrl } = useFileManager();
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <Image
          src={!enableUseFileManager ? ImageUrl : imageURL || fallbackImage}
          alt="Image"
                    ...
                    if (uploadFile && uploadFile.originFileObj) {
                      ...
                      if (imageFileName) {
                        ...
                        try {
                          ...
                          if (!response.ok) {
                            showImageUploadFailMessage();
                          } else {
                            if (enableUseFileManager) download(processId as string, imageFileName);
