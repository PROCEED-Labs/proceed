declare const _exports: {
    ...
    setProceedElement(element: object, proceedElementType: string, value: any, attributes?: object, oldAttributes?: object): object;
    ...
    setScriptTaskData(bpmn: string | object, scriptTaskId: string, newFileName: string): Promise<string | object>;
    ...
    updatePerformersOnElementById(bpmn: string | object, elementId: string, performers: any[]): Promise<string | object>;
    updateBpmnCreatorAttributes(bpmn: string | object, attributes: {
        id?: string;
        name?: string;
        creatorId?: string;
        creatorName?: string;
    ...
    updateBpmnOriginalAttributes(bpmn: string | object, attributes: {
        originalId?: string;
        originalName?: string;
