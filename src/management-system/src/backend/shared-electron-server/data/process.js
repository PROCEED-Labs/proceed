...
const { getProcessInfo, getDefaultProcessMetaInfo } = processHelperEx;
 ...
 * @returns {Object|string} - returns an object containing the intitial process information or its id if a process with the same id already exists
 */
 ...
 */
async function removeAdaptationProcesses(processes) {
...
export async function init() {
  ...
  updatedProcesses = await removeAdaptationProcesses(updatedProcesses);
