declare const _exports: {
  ...
  validateCalledProcess(xml: string, processId: string): boolean;
  ...
  setProcessId(bpmn: string, id: string): string;
  setTemplateId(bpmn: any, id: any): Promise<any>;
  ...
  setMachineInfo(bpmn: string | object, machineInfo: object[]): string | object;
  setUserTaskData(
    bpmn: string | object,
    userTaskId: string,
    newFileName: string,
  ...
  removeCallActivityReference(bpmn: string | object, callActivityId: string): string | object;
  removeUnusedCallActivityReferences(bpmn: string | object): string | object;
  removeColorFromAllElements(bpmn: any): Promise<any>;
  addDocumentation(bpmn: string | object, description: string): string | object;
  addDocumentationToProcessObject(processObj: object, description: string): Promise<void>;
