...
- Admin: The password for this user can be found in the private Environment Configurations repository.
- John Doe: With the username `johndoe` and the password `JohnDoe2023!`.
