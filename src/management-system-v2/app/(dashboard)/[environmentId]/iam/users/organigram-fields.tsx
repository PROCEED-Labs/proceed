    ...
    <>
      ...
      <Form.Item
        label={
          <LabelWithTooltip
            ...
            tooltip="Specify the user's spatial team or department."
          />
        }
        name="teamRoleId"
      >
      ...
      <Form.Item
        label={
          <LabelWithTooltip
            ...
            tooltip="Specify the user's direct, spatial manager."
          />
        }
      ...
      <Form.Item
        label={
          <LabelWithTooltip
            label="Back Office"
            tooltip="Specify the user's spatial back office. (The user will not become a member of that role.)"
          />
        }
