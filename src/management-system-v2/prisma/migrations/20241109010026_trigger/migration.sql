...
-- Trigger for artifact_process_reference
CREATE TRIGGER update_refcounter_on_artifact_process_reference_change
AFTER INSERT OR DELETE ON artifact_process_reference
FOR EACH ROW
EXECUTE FUNCTION update_artifact_refcounter();

-- Trigger for artifact_version_reference
CREATE TRIGGER update_refcounter_on_artifact_version_reference_change
AFTER INSERT OR DELETE ON artifact_version_reference
FOR EACH ROW
EXECUTE FUNCTION update_artifact_refcounter();
