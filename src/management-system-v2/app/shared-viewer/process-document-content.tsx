  ...
  if (isRoot) {
      ...
      <div
        ...
        className={cn(styles.ElementPage, {
          [styles.ContainerPage]:
            isContainer &&
            !isCollapsedSubprocess(hierarchyElement) &&
            !hierarchyElement.importedProcess,
        })}
      >
    ...
    if (
      ...
      for (const child of mainChildren) {
        await getContent(child, importedMainPages, importedSubprocessPages, params, false);
      }

      for (const sub of subprocessChildren) {
        if (!sub.nestedSubprocess) {
          await getContent(sub, importedMainPages, importedSubprocessPages, params, false);
        }
      }
